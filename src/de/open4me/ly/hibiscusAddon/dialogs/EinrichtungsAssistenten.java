package de.open4me.ly.hibiscusAddon.dialogs;
...
public class EinrichtungsAssistenten extends AbstractDialog
{
	...
	{
		super(position);
		setTitle("Einrichtungsassistenten");
	}


	public String lade(String name) throws IOException {
		// Hilfe fuer das eingestellte Locale laden
		String path = "de/open4me/ly/hibiscusAddon/help/de_de/EinrichtungsAssistentenMP/EA" + name + ".txt";
